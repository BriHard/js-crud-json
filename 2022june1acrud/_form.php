             ...
             <form action="" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input name="name" value="<?php echo $user['name'] ?>"
                       class="form-control <?php echo $errors['name'] ? 'is-valid' : '' ?>">
                ...
                <div class="form-group">
                    ...
                    <input name="username" value="<?php echo $user['username'] ?>"
                       class="form-control <?php echo $errors['username'] ? 'is-valid' : '' ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input name="email" value="<?php echo $user['email'] ?>"
                       class="form-control <?php echo $errors['email'] ? 'is-valid' : '' ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input name="phone" value="<?php echo $user['phone'] ?>"
                       class="form-control <?php echo $errors['phone'] ? 'is-valid' : '' ?>">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input name="website" value="<?php echo $user['website'] ?>"
                       class="form-control <?php echo $errors['website'] ? 'is-valid' : '' ?>">
                    <div class="invalid-feedback">
